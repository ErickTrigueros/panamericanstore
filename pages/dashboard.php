        ...
        <div class="box-body"><!-- Inicio Body-->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="tablereport.php" class="small-box-footer">Más info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
            ...
            <?php 
                  $select = $pdo->prepare("select count(idp) as p from tbl_product");
                  $select->execute();
                  $row=$select->fetch(PDO::FETCH_OBJ);
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="productlist.php" class="small-box-footer">Más info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>

            <?php /** Query para traer data de productos totales de la BD-->*/
                $select = $pdo->prepare("select sum(pstock) as cate from tbl_product");
                $select->execute();
                $row=$select->fetch(PDO::FETCH_OBJ);
