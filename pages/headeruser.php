...
<head>
  ...
  <title>Panamerican Store | User</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="user.php"><i class="fa fa-dashboard"></i> <span>Catalogo</span></a></li>

        <!--<li><a href="createorderuser.php"><i class="fa fa-first-order"></i> <span>Crear Pedido</span></a></li>-->

        <li><a href="orderlistuser.php"><i class="fa fa-list-ul"></i> <span>Lista de Reservas</span></a></li>
