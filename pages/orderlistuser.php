            ...
            <div class="box-body">
                ...
                <div style="overflow-x:auto;" > <!-- Inicio scroll para tabla -->
                        <table id ="orderlisttable" class="table table-Striped">
                                ...
                                <tbody>
                                    <?php
                                   $USERNAME =$_SESSION['name']." ".$_SESSION['surname'];// to get the username
                        
                                   //$select=$pdo->prepare("select * from tbl_user where username='$username'");
                                    $select=$pdo->prepare("select * from tbl_invoice where customer_name = '$USERNAME' order by invoice_id asc");//Obtengo los datos
